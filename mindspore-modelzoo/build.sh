...
cp -r /usr1/package630/mindspore-modelzoo-data-model/Resnet50_Cifar_for_MindSpore .
cp -r /usr1/package630/mindspore-modelzoo-data-model/Resnet50_imagenet2012_for_MindSpore .
cp -r /usr1/package630/mindspore-modelzoo-data-model/vpc_resnet50_imagenet_classification .
