...
if [ $arch == "x86_64" ];then
    docker build -t ascend-algorithm:centos7-x64 --build-arg BASE_VERSION=centos7-x64 . || exit 1
    ...
    docker build -t ascend-algorithm:centos7-arm64 --build-arg BASE_VERSION=centos7-arm64 . || exit 1
